...
public class GeocodingService {
    private static final String URL_TEMPLATE = "https://nominatim.openstreetmap.org/reverse?format=json&lat={lat}&lon={lon}&zoom=18&addressdetails=1&email=konstant.matrokhin@gmail.com";
